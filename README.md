...
## Change Log and Updates
    [07.05.2026]: disabling convolution of `error_array` in `ficus_script.py`.
    [06.05.2026]: swtiching np.float_() to np.float64() in `ficus.py`.
    [05.05.2026]: python `trapz` funtion updated from scipy to numpy in `ficus_script.py`.
